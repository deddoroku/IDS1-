...
```{r setup-tibble}
team_data <- tibble(
  name = c("Lidia Lomakina", "Leo Lin", "member 2", 
           "member 3", "member 4"),
  github_username = c("deddoroku", "leo-lin1", "username 2", 
                      "username 3", "username 4"), 
  colour = c("turquoise1", "red", "colour 2", 
             "colour 3", "colour 4"),
  hobby = c("piano", "basketball", "hobby 2", 
            "hobby 3", "hobby 4"),
  favourite_number = c(9, 3, NA, NA, NA)
  )
